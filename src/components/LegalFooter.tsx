/* 🔑 Keywords: Credentials AI profile builder legal footer, Privacy, Terms, Beastly Tech GC ABN */
...
export function LegalFooter() {
  return (
    <footer className="border-t border-gray-200 bg-white px-4 py-8 text-center text-xs leading-6 text-gray-500">
      <p>Credentials AI Profile Builder creates AI-readable business profiles.</p>

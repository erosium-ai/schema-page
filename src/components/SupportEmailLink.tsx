...
/* 🔑 Keywords: SchemaPage support link, email copy fallback, mailto fallback, support interaction */
...
export function SupportEmailLink({ className }: { className?: string }) {
  ...
  return (
    <span className="inline-flex flex-col items-center">
      ...
      {copyState !== "idle" ? (
        <span className="mt-1 whitespace-nowrap rounded bg-gray-900 px-2 py-1 text-[11px] font-medium text-white shadow-lg">
